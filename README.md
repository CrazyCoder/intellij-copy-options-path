...
| **Animate notification (rise and highlight)**           | Enabled  | When enabled, the notification rises into place and then highlights path segments one by one. Disable for a simple fade-in/fade-out animation.          |
